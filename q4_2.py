...
tag_name = "2-GRAM"
tag_dict = {}
transition_probablity_dict = word_dict
def training_dict():
...
def transition_probablity(word_dict):
    # print tag_dict
    ...
    for item in word_dict.keys():
        for tag in word_dict[item].keys():
            ...
            transition_probablity_dict[item][tag] = probability

    # print transition_probablity_dict
    for key, value in transition_probablity_dict.iteritems():
        print key, value


if __name__ == "__main__":
    training_dict()
    transition_probablity(word_dict)
